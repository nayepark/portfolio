$(function(){
    ...
    $(document).ready(function() {	
        ...
        $('.slide-buttons li:nth-child(4)').trigger('mouseenter')   
    ...
    $(".menu__item-cta").click(function(){
        $(".logo a").addClass("active");
        $(".menu-icon__line").addClass("active2");
        $(".bg-gallery-wrap").addClass("fade");
    });
    
    
    $(".content__back").click(function(){
        $(".logo a").removeClass("active");
        $(".menu-icon__line").removeClass("active2");
        $(".bg-gallery-wrap").removeClass("fade");
